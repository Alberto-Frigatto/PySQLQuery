...
class TestDecimal:
    ...
    def test_quando_recebe_length_4_retorna_DECIMAL_4(self) -> None:
        entry = 4
        expected = 'DECIMAL(4)'
    ...
    def test_quando_recebe_length_4_e_precision_2_retorna_DECIMAL_4_2(self) -> None:
        entry_length = 4
        entry_precision = 2
        expected = 'DECIMAL(4, 2)'
        float_type = Decimal(entry_length, entry_precision)
        result = str(float_type)
    ...
    def test_quando_recebe_length_4_e_precision_0_retorna_DECIMAL_4_0(self) -> None:
        entry_length = 4
        entry_precision = 0
    ...
    def test_quando_recebe_length_4_e_precision_4_lanca_InvalidPrecision(self) -> None:
        with pytest.raises(InvalidPrecision):
            entry_length = 4
            entry_precision = 4
            Decimal(entry_length, entry_precision)
