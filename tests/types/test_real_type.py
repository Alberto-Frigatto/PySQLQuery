...
class TestReal:
    ...
    def test_quando_recebe_precision_4_retorna_REAL_4(self) -> None:
        entry = 4
        expected = 'REAL(4)'
    ...
    def test_quando_recebe_precision_4_e_scale_2_retorna_REAL_4_2(self) -> None:
        entry_precision = 4
        entry_scale = 2
        expected = 'REAL(4, 2)'
        float_type = Real(entry_precision, entry_scale)
        result = str(float_type)
    ...
    def test_quando_recebe_precision_4_e_scale_0_retorna_REAL_4_0(self) -> None:
        entry_precision = 4
        entry_scale = 0
        expected = 'REAL(4, 0)'
        float_type = Real(entry_precision, entry_scale)
    ...
    def test_quando_recebe_precision_4_e_scale_4_lanca_InvalidScale(self) -> None:
        with pytest.raises(InvalidScale):
            entry_precision = 4
            entry_scale = 4
            Real(entry_precision, entry_scale)
