...
class TestColumn:
    def test_quando_coluna_preco_recebe_data_type_Float_7_2_retorna_preco_FLOAT_7_2_NOT_NULL(
        self,
    ) -> None:
        class Tabela(Table):
    ...
    def test_quando_coluna_preco_recebe_data_type_Float_7_2_e_nullable_True_retorna_preco_FLOAT_7_2(
        self,
    ) -> None:
        class Tabela(Table):
    ...
    def test_quando_coluna_email_recebe_data_type_String_255_e_unique_True_retorna_email_VARCHAR_255_NOT_NULL_UNIQUE(
        self,
    ) -> None:
        class Tabela(Table):
    ...
    def test_quando_coluna_saldo_recebe_data_type_Float_7_2_e_default_0_retorna_saldo_Float_7_2_DEFAULT_0(
        self,
    ) -> None:
        class Tabela(Table):
    ...
    def test_quando_coluna_contagem_recebe_data_type_Integer_e_auto_increment_mssql_retorna_contagem_INTEGER_IDENTITY_1_1(
        self,
    ) -> None:
        class Tabela(Table):
    ...
    def test_quando_coluna_contagem_recebe_data_type_Integer_e_auto_increment_mysql_retorna_contagem_INTEGER_AUTO_INCREMENT(
        self,
    ) -> None:
        class Tabela(Table):
    ...
    def test_quando_coluna_contagem_recebe_data_type_Integer_e_auto_increment_sqlite_retorna_contagem_INTEGER_AUTO_INCREMENT(
        self,
    ) -> None:
        class Tabela(Table):
    ...
    def test_quando_coluna_contagem_recebe_data_type_Integer_e_auto_increment_postgree_retorna_contagem_INTEGER_SERIAL(
        self,
    ) -> None:
        class Tabela(Table):
            contagem = Column(Integer, auto_increment='postgre')
    ...
    def test_quando_coluna_id_recebe_data_type_Integer_e_primary_key_True_retorna_id_INTEGER_NOT_NULL(
        self,
    ) -> None:
        class Tabela(Table):
    ...
    def test_quando_coluna_fk_col_recebe_ForeignKey_e_acessamos_a_property_foreign_keys_retorna_repr(
        self,
    ) -> None:
        class Tabela(Table):
    ...
    def test_quando_tabela_recebe_6_colunas_com_unnamed_constraints_elas_retornam_informacoes(
        self,
    ) -> None:
        class Tabela(Table):
    ...
    def test_quando_tabela_recebe_6_colunas_com_named_constraints_elas_retornam_informacoes(
        self,
    ) -> None:
        class Tabela(Table):
    ...
    def test_quando_data_type_recebe_Integer_2_e_default_recebe_123_int_lanca_InvalidDefaultValue(
        self,
    ) -> None:
        with pytest.raises(InvalidDefaultValue):
            Column(Integer(2), default=123)

    def test_quando_data_type_recebe_Integer_2_e_default_recebe_12_float_lanca_InvalidDefaultValue(
        self,
    ) -> None:
        with pytest.raises(InvalidDefaultValue):
            Column(Integer(2), default=12.0)

    def test_quando_data_type_recebe_Integer_2_e_default_recebe_aaa_str_lanca_InvalidDefaultValue(
        self,
    ) -> None:
        with pytest.raises(InvalidDefaultValue):
            Column(Integer(2), default='aaa')

    def test_quando_data_type_recebe_Char_2_e_default_recebe_aaa_str_lanca_InvalidDefaultValue(
        self,
    ) -> None:
        with pytest.raises(InvalidDefaultValue):
            Column(Char(2), default='aaa')

    def test_quando_data_type_recebe_Char_2_e_default_recebe_123_int_lanca_InvalidDefaultValue(
        self,
    ) -> None:
        with pytest.raises(InvalidDefaultValue):
            Column(Char(2), default=123)

    def test_quando_data_type_recebe_Char_2_e_default_recebe_12_float_lanca_InvalidDefaultValue(
        self,
    ) -> None:
        with pytest.raises(InvalidDefaultValue):
            Column(Char(2), default=12.0)
    ...
    def test_quando_tabela_recebe_2_ForeignKeyConstraint_para_mesma_coluna_lanca_ColumnAlreadyHasNamedForeignKeyConstraint(
        self,
    ) -> None:
        class Tabela(Table):
            col = Column(Integer)
    ...
    def test_quando_tabela_recebe_2_UniqueConstraint_para_mesma_coluna_lanca_ColumnAlreadyHasNamedUniqueConstraint(
        self,
    ) -> None:
        class Tabela(Table):
            col = Column(Integer)
    ...
    def test_quando_coluna_recebe_uma_PrimaryKeyConstraint_na_tabela_e_acessamos_is_primary_key_named_retorna_True(
        self,
    ) -> None:
        class Tabela(Table):
            col = Column(Integer)

            __constraints__ = [PrimaryKeyConstraint('pk_tabela', 'col')]
    ...
    def test_quando_coluna_recebe_primary_key_True_e_acessamos_is_primary_key_named_retorna_False(
        self,
    ) -> None:
        class Tabela(Table):
    ...
    def test_quando_coluna_recebe_uma_ForeignKeyConstraint_na_tabela_e_acessamos_is_foreign_key_named_retorna_True(
        self,
    ) -> None:
        class Tabela(Table):
            col = Column(Integer)
    ...
    def test_quando_coluna_recebe_ForeignKey_e_acessamos_is_foreign_key_named_retorna_False(
        self,
    ) -> None:
        class Tabela(Table):
